...
factor(online$Fecha) <- ya te dice por algún lado cuantos elementos distintos hay (603)


length(levels(factor(online$Fecha)))

> ## 10. Calcula cuántos compradores distintos hay en el dataset.

length(levels(factor(online$IDcomprador))) <- 1139, aunque ya lo sabíamos antes gracias a summary...

> ## 11. Calcula cuántos productos distintos se han vendido.

length(levels(factor(online$ProductoComprado))) <- 38
